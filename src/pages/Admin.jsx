...
const Admin = () => {
	...
	return (
		<div className='background bg-gray-500 h-screen'>
			<Navbar />
			...
			<div className='card flex justify-center'>
				<div className='flex flex-col md:flex-row md:max-w-xl m-5 rounded-lg bg-white shadow-lg'>
					<form className='form' onSubmit={onFormSubmit}>
						<input
							placeholder='This is a wider card with supporting text below as a natural
					...
					<div className='p-6 flex flex-col justify-start'>
						...
						<Link to='/check-costs'>
							<button className='text-white bg-gray-500 shadow-lg text-xs p-3 rounded-lg hover:bg-blue-700 '>
